...
[Server Discord ](https://discord.gg/5SUCHGBR)
...
1 . [Install Wallet](https://www.aurowallet.com/) Ganti Jaringan Berkeley

2 . [Mina Faucet](https://faucet.minaprotocol.com/) Masukin Address Jaringan Berkeley
...
sudo ufw allow ${MINA_PORT}22,${MINA_PORT}3000/tcp
sudo ufw enable	
```
